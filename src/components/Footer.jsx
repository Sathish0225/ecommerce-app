                                            ...
                                            <ul className="lab-ul social-icons">
                                                {
                                                    socialList.map((item, i) => (
                                                        <li key={i}><a href="#"><i className={item.iconName}></i>{item.text}</a></li>
                                                    ))
                                                }
                                            </ul>
                                        </div>
                                            ...
                                            <ul className="lab-ul office-address">
                                                {
                                                    tweetList.map((item, i) => (
                                                        <li key={i}><i className={item.iconName}></i>{item.desc}</li>
                                                    ))
                                                }
                                            </ul>
                                        </div>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2024 <Link to="/"> Shop Cart</Link> Designed by <a href="/" target='_blank'>Ranganathan Sathishkumar</a></p>
                        <div className="footer-bottom-list">
                            {
                                footerbottomList.map((item, i) => (
                                    <Link key={i} to={item.link}>{item.text}</Link>
                                ))
                            }
                        </div>
                    </div>
